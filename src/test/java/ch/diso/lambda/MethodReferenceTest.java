...
public class MethodReferenceTest {
    ...
    private Predicate<String> makeIgnoreCaseMatcher(String pattern) {
    ...
    public void testMethodRefInstance1() {
        ...
        assertTrue(makeIgnoreCaseMatcher("true").test("TruE"));
        assertTrue(makeIgnoreCaseMatcher("false").test("FalsE"));
        assertFalse(makeIgnoreCaseMatcher("true").test("FalsE"));
    }
