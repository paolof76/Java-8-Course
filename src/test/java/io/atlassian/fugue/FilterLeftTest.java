...
public class FilterLeftTest {
    ...
    @Test
    public void rightOnlyFiltersLeftToEmpty() {
    ...
    @Test
    public void leftOnlyFiltersLeftToSameContents() {
    ...
    @Test
    public void mixedEithersFiltersLeftToExpectedContents() {
    ...
    @Test
    public void emptyIterableFiltersLeftToEmptyIterable() {
