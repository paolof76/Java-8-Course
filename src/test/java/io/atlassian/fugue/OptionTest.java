...
public class OptionTest {
    ...
    @Test
    public void getElseOnNoneReturnsValueFromSupplier() {
        assertThat(none(Integer.class).getOr(ofInstance(0)), is(equalTo(0)));
    }

    @Test
    public void getElseOnNoneReturnsValueFromLambda() {
