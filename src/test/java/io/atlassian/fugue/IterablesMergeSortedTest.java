...
public class IterablesMergeSortedTest {
    ...
    @Test
    public void mergingEmptyIterablesGivesAnEmptyIterable() {
    ...
    @Test
    public void mergingNonEmptyAndEmptyIterablesGivesTheMergedIterable() {
        assertThat(mergeSorted(Arrays.asList(singletonList("a"), emptyList())), contains("a"));
    }

    @Test
    public void mergingEmptyAndNonEmptyIterablesGivesTheMergedIterable() {
        assertThat(mergeSorted(Arrays.asList(emptyList(), singletonList("a"))), contains("a"));
    }

    @Test
    public void mergingNonEmptyIterablesInOrderGivesMergedIterable() {
        assertThat(mergeSorted(Arrays.asList(singletonList("a"), singletonList("b"))), contains("a", "b"));
    }

    @Test
    public void mergingNonEmptyIterablesOutOfOrderGivesMergedIterable() {
        assertThat(mergeSorted(Arrays.asList(singletonList("b"), singletonList("a"))), contains("a", "b"));
    }

    @Test
    public void mergingNonEmptyIterablesOutOfOrderGivesMergedIterableInOrder() {
        assertThat(mergeSorted(Arrays.asList(Arrays.asList("b", "d"), Arrays.asList("a", "c", "e"))), contains("a", "b", "c", "d", "e"));
    }

    @Test
    public void mergingManyNonEmptyIterablesOutOfOrderGivesMergedIterableInOrder() {
        assertThat(
