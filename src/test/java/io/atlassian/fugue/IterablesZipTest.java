...
public class IterablesZipTest {
    ...
    @Test
    public void zipFromLists() {
        assertThat(zip(asList(4, 3, 2, 1), asList(1, 2, 3, 4)), genericContains(pair(4, 1), pair(3, 2), pair(2, 3), pair(1, 4)));
    }

    @SuppressWarnings("unchecked")
    @Test
    public void zipFromLongerFirstList() {
        assertThat(zip(asList(4, 2, 3, 1, 12), asList(1, 2, 3, 4)), genericContains(pair(4, 1), pair(2, 2), pair(3, 3), pair(1, 4)));
    }

    @SuppressWarnings("unchecked")
    @Test
    public void zipFromLongerLastList() {
        assertThat(zip(asList(4, 3, 2, 1), asList(6, 2, 5, 4, 5, 6)), genericContains(pair(4, 6), pair(3, 2), pair(2, 5), pair(1, 4)));
    }

    @Test
    public void zipWithFrom() {
