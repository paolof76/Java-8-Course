...
public class FilterRightTest {
    ...
    @Test
    public void leftOnlyFiltersRightToEmpty() {
    ...
    @Test
    public void rightOnlyFiltersRightToSameContents() {
    ...
    @Test
    public void mixedEithersFiltersRightToExpectedContents() {
    ...
    @Test
    public void emptyIterableFiltersRightToEmptyIterable() {
