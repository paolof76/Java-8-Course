...
public class IterablesTest {
    ...
    @Test
    public void emptyIterableIteratorHasNext() {
        assertThat(emptyIterable().iterator().hasNext(), is(false));
    }

    @Test(expected = NoSuchElementException.class)
    public void emptyIterableIteratorNext() {
        emptyIterable().iterator().next();
    }

    @Test(expected = UnsupportedOperationException.class)
    public void emptyIterableIteratorRemove() {
        emptyIterable().iterator().remove();
    }

    @Test
    public void emptyIterablesAreEqual() {
        assertThat(emptyIterable(), is(emptyIterable()));
    }

    @Test
    public void emptyIterablesToString() {
    ...
    @Test
    public void findAnyNoMatching() {
        assertThat(any(Arrays.asList(1, 2, 3), ii -> ii < 0), is(false));
    }

    @Test
    public void findAnyEmpty() {
    ...
    @Test
    public void mapChangesIterable() {
