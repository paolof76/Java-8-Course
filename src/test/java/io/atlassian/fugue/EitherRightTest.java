...
public class EitherRightTest {
    ...
    @Test
    public void rightIsDefined() {
        assertThat(either.right().isDefined(), is(true));
    }

    @Test
    public void leftIsDefined() {
    ...
    @Test
    public void flatMapRightSubTypes() {
        class Type {
        }
    ...
    @Test
    public void flatMapRightWithUpcastAndSubtypes() {
        class Type {
        }
