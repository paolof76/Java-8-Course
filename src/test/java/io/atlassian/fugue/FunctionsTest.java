...
import static io.atlassian.fugue.Functions.*;
import static io.atlassian.fugue.Iterables.map;
import static io.atlassian.fugue.Option.none;
import static io.atlassian.fugue.Option.some;
import static io.atlassian.fugue.UtilityFunctions.*;
...
public class FunctionsTest {
    ...
    @Test
    public void functionsConstant() {
        assertThat(map(Arrays.asList(1, 2, 3), constant(1)), contains(1, 1, 1));
    }

    @Test
    public void countingPredicateWithOne() {
    ...
    @Test
    public void countingPredicateWithZero() {
        final Predicate<Integer> p = countingPredicate(0);
        assertThat(p.test(1), is(false));
    }

    @Test(expected = IllegalArgumentException.class)
    public void countingPredicateWithNegative() {
        countingPredicate(-1);
    }

    @Test
    public void forMapWithDefaultWithValue() {
    ...
    @Test
    public void forMapWithDefaultWithNullValue() {
        assertThat(forMapWithDefault(new HashMap<Integer, Integer>() {
            {
                put(1, 1);
            }
    ...
    @Test
    public void forMapWithDefaultWithNoValue() {
        assertThat(forMapWithDefault(new HashMap<Integer, Integer>() {
            {
                put(1, 1);
            }
    ...
    @Test
    public void forMapWithNullValue() {
        assertThat(forMap(new HashMap<Integer, Integer>() {
            {
                put(1, 1);
            }
