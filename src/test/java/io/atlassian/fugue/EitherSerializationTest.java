...
public class EitherSerializationTest {
    ...
    public void serializeLeftNonSerializable() throws IOException {
        toObject(toBytes(Either.left(Serializer.Unserializable.instance())));
    }

    @Test(expected = NotSerializableException.class)
    public void serializeRightNonSerializable() throws IOException {
