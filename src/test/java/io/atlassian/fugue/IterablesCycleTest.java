...
import static io.atlassian.fugue.Iterables.cycle;
...
public class IterablesCycleTest {
    ...
    @Test
    public void canCycleFewerElements() {
        assertThat(take(2, cycle(1, 2, 3, 4)), contains(1, 2));
    }

    @Test
    public void canCycleNoElements() {
    ...
    @Test
    public void toStringResultNull() {
        assertThat(cycle(1, 2, null).toString(), is("[1, 2, null...]"));
    }

    @Test(expected = UnsupportedOperationException.class)
    public void removeOnOutput() {
