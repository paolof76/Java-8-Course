...
public class ParallelStreamsMeasurement {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Range forkJoinSum done in: " + measurePerformance(ParallelStreams::rangedSum, 10_000_000L) + " msecs");
        System.out.println("Parallel range forkJoinSum done in: " + measurePerformance(ParallelStreams::parallelRangedSum, 10_000_000L) + " msecs");
        ...
        System.out.println("SideEffect prallel sum done in: " + measurePerformance(ParallelStreams::sideEffectParallelSum, 10_000_000L) + " msecs");
    }
